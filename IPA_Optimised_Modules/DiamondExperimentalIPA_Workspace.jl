...
function post_process_diamond(
    ...
    subgraph_outgoing = Dict(n => Set{Int64}() for n in subgraph_nodes)
    subgraph_incoming = Dict(n => Set{Int64}() for n in subgraph_nodes)
...
function path_based_diamond_detection(potential_common_ancestors::Set{Int64}, current_join::Int64, subgraph_outgoing::Dict{Int64, Set{Int64}}, original_descendants::Dict{Int64, Set{Int64}})
...
function find_all_paths(start::Int64, goal::Int64, subgraph_outgoing::Dict{Int64, Set{Int64}}, original_descendants::Dict{Int64, Set{Int64}})
