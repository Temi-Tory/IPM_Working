...
holds without further assumption. For example, treatment trains, supply chains, assembly
processes and project schedules move material or work strictly forward, and a dependency cycle
in a schedule would be a planning error. For other systems, however, acyclicity is
...
Every analysis in the following chapters is an exact method with no iterative convergence
