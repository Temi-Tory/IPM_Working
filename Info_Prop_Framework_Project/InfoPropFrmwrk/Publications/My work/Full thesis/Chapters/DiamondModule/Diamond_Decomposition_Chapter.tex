...
structure that Chapter~\ref{ch:system-model} identified as the designed redundancy of
...
overlap instead of branching cleanly \cite{ouyang2014interdependent,buldyrev2010cascade}. Redundancy strategies are the obvious
case. A robust network supplies more than one route to the
same goal by design, so paths diverge and reconverge. Process networks and
...
Given this, the diamond subgraph is defined formally as follows.
