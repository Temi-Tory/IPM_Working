...
println("🚀 Enhanced server running on: http://localhost:9090")
...
# Start server
HTTP.serve(route_handler, "127.0.0.1", 9090) #(only localhost):
#HTTP.serve(route_handler, "0.0.0.0", 9090) #(all interfaces)